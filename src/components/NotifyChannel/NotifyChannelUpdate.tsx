...
import { NotifyChannelUpdateProps } from '../../types/notifyChannel';
...
const NotifyChannelUpdate = ({
  ...
  return (
    <Fragment>
      <FormCardWrap id='notify-channel-update'>
        <FormCardTitle>
          <h1>알림 채널 수정</h1>
        ...
        <div className='card-foot'>
          <div className='form-item-cancel'>
            <button className='btn-item-cancel' id='notifyChannel-update-cancel-btn' onClick={() => toggle()}>
              <FontAwesomeIcon icon={faTimesCircle} style={{paddingRight:'3px'}}/><span>취소</span>
            </button>
          </div>
          <div className='form-item-add center'>
            <button className='btn-item-add' id='notifyChannel-update-add-btn' onClick={handleUpdateNotifyChannel}>
...
export default NotifyChannelUpdate;
...
import { StaffCreateProps } from '../../types/staff';
      ...
      <FormCardWrap>
        ...
        <div className='inline-flex'>
          <div className='w-100'>
            <div className='card-text'>
              <p>
                <b>스태프이름</b><span className='required'>*</span>
              </p>
              <input
                className='card-text-input'
                placeholder='스태프 이름을 입력 해주세요.'
            ...
            <div className='card-text'>
              <p>
                <b>권한</b><span className='required'>*</span>
              </p>
              <select
            ...
            <div className='card-text'>
              <p>
                <b>전화번호</b><span className='required'>*</span>
              </p>
              <select
                className='card-text-select'
        ...
        <div className='card-foot'>
          <div className='form-item-cancel'>
            <button className='btn-item-cancel' id='staff-create-cancel-btn' onClick={() => toggle()}>
              <FontAwesomeIcon icon={faTimesCircle} style={{paddingRight:'3px'}}/><span>취소</span>
            </button>
          </div>
          <div className='form-item-add center'>
            <button className='btn-item-add' id='staff-create-add-btn' onClick={handleCreateStaff}>
